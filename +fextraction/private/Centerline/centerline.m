...
%}
%%
function [CL, branchMat, branchList, branchTextList, junctionMat, junctionList] = centerline(Y, vMean, spurLength, sortingCriteria, res)
    modified = 1;
    Niter = 0;
    ...
    %         end
        ...
        [x0, y0, z0] = ind2sub([res res res], junctionIndices);
        junctionMat = zeros(res,res,res);    % label matrix
        ...
        [x0, y0, z0] = ind2sub([res res res], branchIndices);
        branchMat = zeros(res,res,res);    % label matrix
