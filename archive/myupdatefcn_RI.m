...
count = 1;
global RI_vol branchList PointLabel branchLabeled Ntxt flowPulsatile_vol fig res Planes p dcm_obj hfull timeMIPcrossection segment1 vTimeFrameave
...
txt = {['Point Label:' , PointLabel , sprintf('\n'), ...
    'Resistance Index: ',sprintf('%0.3f',value), sprintf('\n'), ...
