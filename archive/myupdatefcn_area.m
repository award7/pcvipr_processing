...
global area_vol branchLabeled PointLabel branchList flowPulsatile_vol res Planes p dcm_obj Ntxt hfull timeMIPcrossection segment1 vTimeFrameave fig
...
txt = {['Point Label:' , PointLabel , sprintf('\n'), ...
    'Area: ', sprintf('%0.3f',value),  ' cm^2 ', sprintf('\n'), ...
    'Average: ',sprintf('%0.3f',mean(average)), ' cm^2',sprintf('\n'), ...
