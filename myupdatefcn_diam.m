...
count = 2;
global diam_vol branchList PointLabel branchLabeled Ntxt flowPulsatile_vol res Planes fig p dcm_obj hfull timeMIPcrossection segment1 vTimeFrameave
...
txt = {['Point Label:' , PointLabel , sprintf('\n'), ...
    'Diameter: ',sprintf('%0.3f',value),  ' cm ', sprintf('\n'), ...
    'Average: ',sprintf('%0.3f',mean(average)), ' cm', sprintf('\n'), ...
